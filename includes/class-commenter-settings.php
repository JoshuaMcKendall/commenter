...
class Commenter_Settings { 
	...
	public function __get( $id = null ) {
		$settings = apply_filters( 'commenter_settings_field', array() );
	...
	public static function instance( $prefix = null ) {
		...
		if ( !empty( self::$_instance[$prefix] ) ) {
			...
			return $GLOBALS['commenter_settings'] = self::$_instance[$prefix];
		}

		return $GLOBALS['commenter_settings'] = self::$_instance[$prefix] = new self( $prefix );
	}
