...
/**
 * This class handles sessions for Commenter.
 *
 * @since      1.0.0
 * @package    Commenter_Session
 * @subpackage Commenter/includes
...
class Commenter_Session {
	...
	public function __construct() {
		session_start();
		$this->_name = 'commenter_session_' . COOKIEHASH;
