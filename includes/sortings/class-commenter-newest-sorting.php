...
/**
 * The newest sorting class that sorts from newest to oldest comments in a thread.
 *
 *
 * @since      1.0.0
 * @package    Commenter
...
class Commenter_Newest_Sorting extends Commenter_Abstract_Sorting {
	...
	public function get_comments_count_before_or_after( $comment ) {
		...
		$this->args['date_query'] = array(
			...
			array(
				...
				'after'				=> $comment->wp_comment->comment_date_gmt
